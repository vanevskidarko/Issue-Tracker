...
<body class="theme-light preload-active aside-active aside-mobile-minimized aside-desktop-maximized" id="fullscreen">
	...
	<div class="holder">
        ...
        <form method="POST" action="functions/add_complaint.php">
				<div class="form-group">
					<label for="exampleFormControlInput1">Contact</label>
					<input type="text" class="form-control" name="contact" id="exampleFormControlInput1" placeholder="Name">
				</div>
				<div class="form-group">
					<label for="exampleFormControlSelect1">Type Of Communication</label>
						<select class="form-control" name="type_comm_id" id="exampleFormControlSelect1">
				...
				<div class="form-group">
					...
					<textarea class="form-control" name="complain_comment" id="exampleFormControlTextarea1" rows="3"></textarea>
				</div>
